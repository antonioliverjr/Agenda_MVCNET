...
namespace Agenda_AspNet.Controllers
{
    public class ContatoController : Controller
    {
        ...
        {
            Console.WriteLine(contato.categoria_id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nome,sobrenome,telefone,email,data_criacao,descricao,foto,ativo")] Contato contato)
        {
            if (id != contato.id)
            {
                return NotFound();
